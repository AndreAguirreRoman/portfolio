...
class Blog extends Component {
  constructor() {
    ...
    window.addEventListener("scroll", this.onScroll, false) //????? why false?
  ...
  getBlogItems() {
    ...
    axios.get(`https://andreaguirre.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {
