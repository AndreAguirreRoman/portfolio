...
export default class BlogDetail extends Component {
    ...
    constructor(props) {
        ...
        this.handleEditCick = this.handleEditCick.bind(this);
    ...
    getBlogItem() {
        axios.get(`https://andreaguirre.devcamp.space/portfolio/portfolio_blogs/${this.state.currentId}`
        ).then(response => {
            this.setState({
            ...
            if (this.state.editMode && this.props.loggedInStatus === "LOGGED_IN") {
                ...
                return (
                    <div className="content-container">
                        <h1 onClick={this.handleEditCick}>{title}</h1>
